...
export default function Signup() {
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] flex">
      {/* Left half - Space background with logo and astronaut */}
          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Create your istokx.com account with no fees, no 
                commitments just powerful tools to grow your portfolio
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <button onClick={()=>navigate("/verify")} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900">
                Create an account
              </button>
            </div>
          </div>
