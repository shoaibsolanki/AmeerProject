    ...
    <div className="min-h-screen bg-black text-white py-10 px-4 flex justify-center">
      <div className="max-w-7xl w-full flex flex-col md:flex-row gap-10">
        ...
        <section className="flex-1">
          <button onClick={()=>navigate(-1)}  className="cursor-pointer text-xs text-gray-400 mb-4 flex items-center">
          ...
          <p className="text-gray-400 mb-6 text-sm max-w-lg">
            There’s no charges during your free trial. We’ll only use this info to process your plan payment if you decide to continue after the trial ends.
          </p>
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody>
                <tr className="border-b border-[#23232a]">
                  <td className="py-4 pl-6 pr-4 font-medium">iStokx Intraday Levels Indicator</td>
                  ...
                  <td className="py-4 pr-6 pl-2 cursor-pointer text-gray-400 hover:text-red-500">
                    ...
                    <svg width={18} height={18} fill="none">
                      <rect x="5" y="7" width="8" height="7" rx="1.5" stroke="currentColor" strokeWidth={1.5}/>
                      <path d="M7 9v3M11 9v3" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round"/>
                      <path d="M4 7h10" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round"/>
                      <rect x="7" y="3" width="4" height="2" rx="1" stroke="currentColor" strokeWidth={1.2}/>
                    </svg>
                  </td>
                </tr>
                <tr>
        ...
        <aside className="w-full max-w-sm bg-gradient-to-b from-[#23243A] to-[#171726] shadow-md rounded-xl border border-[#25263a] p-6 flex flex-col gap-5 mt-6 md:mt-0 self-start">
          <div>
            <div className="text-sm text-gray-400 mb-2 font-bold">Order Summary</div>
            <div className="flex justify-between mb-1 text-[15px]">
              <div className="text-gray-200">iStokx Intraday Levels Indicator</div>
          ...
          <div className="bg-[#232852] border border-[#3166d8] rounded-lg px-3 py-3 mt-1">
            <div className="flex items-center mb-1 gap-2">
              <svg width={20} height={20} fill="none">
                <rect x="2.5" y="4.5" width="15" height="11" rx="2" stroke="#55aaff" strokeWidth="1.5" />
                <rect x="7" y="9" width="6" height="2.5" rx="1.25" fill="#55aaff" />
              </svg>
              <span className="text-[#55aaff] font-medium text-sm">Secure Payment</span>
            </div>
