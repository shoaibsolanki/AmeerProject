...
const activities = [
  {
    ...
    icon: (
      <CheckCircle
        size={16}
        className="text-green-400 inline ml-1 align-middle"
      />
    ),
  ...
  },
  {
    ...
    icon: (
      <ArrowRightLeft
        size={16}
        className="text-blue-400 inline ml-1 align-middle"
      />
    ),
  ...
  },
  {
    ...
    icon: (
      <ShoppingCart
        size={16}
        className="text-purple-400 inline ml-1 align-middle"
      />
    ),
  ...
  },
  {
    ...
    info: "New purchase - Enterprise Tier",
    icon: (
      <XCircle size={16} className="text-red-400 inline ml-1 align-middle" />
    ),
    detail: "text-red-400",
    time: "2 hours ago",
  },
    ...
    <div className="bg-black min-h-screen text-gray-200 p-6 font-sans">
      ...
      <div className="flex gap-4 mt-3">
        {statCards.map((card) => (
          ...
          >
            <span
              className={`absolute top-4 right-4 rounded-full p-2 ${card.circle}`}
            >
              {card.icon}
            </span>
      ...
      <div className="mb-7 mt-7 p-6 bg-[#0A0A0A] rounded-lg border border-gray-800 shadow-md">
        <div className="text-sm text-gray-400 mb-2 font-medium pl-1">
          Quick Actions
        </div>
